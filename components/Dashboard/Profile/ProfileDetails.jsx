  ...
  return (
    <section className="my-8 p-4 md:p-6 bg-primary-bg space-y-4">
      <div className=" items-center grid md:grid-cols-12  justify-between text-primary-color-light   gap-1  md:gap-8">
        ...
        <input
          className="flex-1 col-span-8 border px-3 py-2 bg-primary-white-light rounded-md placeholder:text-xs focus:outline-none text-dark-grey-color-light focus:border-purple focus:ring-0 focus:shadow-purple focus:ring-purple"
          type="text"
